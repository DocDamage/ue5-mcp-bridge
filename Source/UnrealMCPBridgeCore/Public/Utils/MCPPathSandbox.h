...
namespace FMCPPathSandbox
{
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool Resolve(const FString& InPathRaw, FString& OutAbsPath, FString& OutError);
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool IsInsideSandbox(const FString& AbsolutePath);
}
