...
namespace FMCPPropertyPathParser
{
	 ...
	 * array growth itself.
	 */
	UNREALMCPBRIDGECORE_API bool Parse(const FString& Path, TArray<FPropertyPathStep>& OutSteps, FString& OutError);
	 ...
	 * form they sent).
	 */
	UNREALMCPBRIDGECORE_API FString FormatPath(const TArray<FPropertyPathStep>& Steps);
}
