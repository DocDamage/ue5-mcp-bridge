...
namespace FMCPComponentPathUtils
{
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool ParseComponentPath(
		const FString& Raw,
	 ...
	 */
	UNREALMCPBRIDGECORE_API FString BuildComponentPath(const UActorComponent* Component);
	 ...
	 */
	UNREALMCPBRIDGECORE_API UActorComponent* ResolveComponent(
		const FString& Raw,
		bool bRejectPIE,
		bool& OutAmbiguous,
