...
namespace FMCPScreenshotUtils
{
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool CaptureViewport(
		FViewport* Viewport,
		int32 DesiredWidth,
		int32 DesiredHeight,
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool EncodeImage(
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool EncodeAndSaveToDisk(
		const TArray<uint8>& Pixels,
		int32 Width,
		int32 Height,
		EImageFormat Format,
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool ParseFormat(const FString& Raw, EImageFormat& OutFormat, FString& OutError);
}
