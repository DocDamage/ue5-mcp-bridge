...
namespace FMCPMaterialUtils
{
	 ...
	 */
	UNREALMCPBRIDGECORE_API UMaterialInterface* LoadMaterialInterfaceByPath(
		const FString& Path,
		int32& OutErrorCode,
		FString& OutError);
	 ...
	 */
	UNREALMCPBRIDGECORE_API UMaterialInstanceConstant* LoadMICByPath(
		const FString& Path,
		int32& OutErrorCode,
		FString& OutError);
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool IsMaterialInstanceConstant(const UMaterialInterface* Asset);
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool IsBaseMaterial(const UMaterialInterface* Asset);
	 ...
	 */
	UNREALMCPBRIDGECORE_API UMaterial* WalkToBaseMaterial(UMaterialInterface* Asset);
	 ...
	 */
	UNREALMCPBRIDGECORE_API FString MakeMaterialClassMismatchMessage(
		const FString& Path,
