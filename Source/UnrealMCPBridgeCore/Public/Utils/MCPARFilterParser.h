...
namespace FMCPARFilterParser
{
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool Parse(const TSharedPtr<FJsonObject>& InJson,
	 ...
	 */
	UNREALMCPBRIDGECORE_API uint64 ComputeFilterHash(const FARFilter& Filter);
	 ...
	 */
	UNREALMCPBRIDGECORE_API FString BuildCanonicalString(const FARFilter& Filter);
}
