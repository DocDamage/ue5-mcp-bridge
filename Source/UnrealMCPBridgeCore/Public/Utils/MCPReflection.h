...
namespace FMCPReflection
{
	 ...
	 */
	UNREALMCPBRIDGECORE_API UObject* ResolveObjectPath(const FString& Path);

	/** Lookup a UScriptStruct by its full path name (e.g. ``/Script/CoreUObject.Vector``). */
	UNREALMCPBRIDGECORE_API const UScriptStruct* ResolveScriptStructPath(const FString& Path);
	 ...
	 */
	UNREALMCPBRIDGECORE_API FString DescribePropertyType(const FProperty* Prop);

	/** Build a ``{name, type, flags, offset}`` JSON summary of one FProperty. Used by list/describe. */
	UNREALMCPBRIDGECORE_API TSharedRef<FJsonObject> MakePropertySummary(const FProperty* Prop);
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool ResolvePropertyPath(
		UObject* RootTarget,
	 ...
	 */
	UNREALMCPBRIDGECORE_API TSharedPtr<FJsonValue> ReadPropertyValueAt(
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool WritePropertyValueAt(
		FProperty* Prop,
		void* ValuePtr,
	 ...
	 */
	UNREALMCPBRIDGECORE_API TSharedPtr<FJsonValue> ReadPropertyValue(
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool WritePropertyValue(
		UObject* Target,
		FProperty* Prop,
		const TSharedPtr<FJsonValue>& Value,
		FString& OutError);
 ...
 */
class UNREALMCPBRIDGECORE_API FMCPWritePropertyScope
{
public:
