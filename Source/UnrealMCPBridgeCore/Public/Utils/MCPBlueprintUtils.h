...
namespace FMCPBlueprintUtils
{
	 ...
	 */
	UNREALMCPBRIDGECORE_API UBlueprint* LoadBlueprintByPath(
		const FString& Path,
		int32& OutErrorCode,
		FString& OutError);
	 ...
	 */
	UNREALMCPBRIDGECORE_API UClass* GetGeneratedClass(const UBlueprint* Blueprint);
	 ...
	 */
	UNREALMCPBRIDGECORE_API bool IsDataOnlyBlueprint(const UBlueprint* Blueprint);
	 ...
	 */
	UNREALMCPBRIDGECORE_API int32 FindVariableIndex(const UBlueprint* Blueprint, const FName VarName);
	 ...
	 */
	UNREALMCPBRIDGECORE_API int32 FindFunctionGraphIndex(const UBlueprint* Blueprint, const FName FunctionName);

	/**
	 * Get the function graph by name, returns nullptr if not found.
	 */
	UNREALMCPBRIDGECORE_API UEdGraph* FindFunctionGraph(const UBlueprint* Blueprint, const FName FunctionName);
}
